...
6. `vocabulary_frequency` is server-only and contains source ranks through 15,000 for English and French from `orgtre/top-open-subtitles-sentences`. RLS intentionally grants no browser read policy.
